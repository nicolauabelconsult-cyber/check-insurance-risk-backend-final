...
# =====================================================
# Armazenamento simples em memória (substituir por BD)
# =====================================================
...
# token_store[token] = {email, name, role, exp}
TOKEN_STORE = {}

TOKEN_TTL_MINUTES = 480  # 8h sessão
...
def get_current_user(credentials: HTTPAuthorizationCredentials = Depends(bearer_scheme)):
    ...
    # Criar um pequeno objeto com email, name, role
    class SessionUser:
