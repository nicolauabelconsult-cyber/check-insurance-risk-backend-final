...
def get_report(consulta_id: str, request: Request, token: str = None, user_email: str = Depends(get_current_user)):
    if not token:
    ...
    headers = {"Content-Disposition": f'attachment; filename="relatorio_{consulta_id}.pdf"'}
